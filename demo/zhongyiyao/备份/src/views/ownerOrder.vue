...
<template>
	<div>
	    ...
	    <Page style="text-align:center;margin-top:20px;" show-total :total="myDataNum" :page-size="pageSize" @on-change="changePageNumber" />
	...
	export default{
		...
		methods:{
			init(){
                ...
                // 获取登陆者病历(订单——买家)信息
                axios.get('orders/getBuyerOrders',{
                	params:param
                }).then((response)=>{
